...
const AdminCreateCaseModal = ({ isOpen, onClose, onSubmit, request }) => {
    const [caseData, setCaseData] = useState({
        partyName: "",
        lawyer: request?.assignedLawyerName || "",
        applicationNumber:
            request?.applicationNumber || request?.requestNumber || "",
        caseSubject: "",
        caseLawyer: "",
        fileNumber: "",
        court: "",
    ...
    const handleSubmit = (e) => {
        ...
        console.log("Gönderilen Veri:", caseData);

        const preparedCaseData = {
            ...caseData,
            relatedRequest: caseData.relatedRequest || null,
        };

        onSubmit(preparedCaseData, files);
    };
        ...
        >
            <div className="bg-white p-8 rounded-lg shadow-xl w-full max-w-4xl relative overflow-y-auto max-h-[90vh]">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="grid grid-cols-2 gap-4 mt-6 bg-gray-100 p-4 rounded-lg hover:shadow-lg transition-shadow duration-500">
                        <FormInput
                            label="Başvuru No"
                            name="applicationNumber"
                            value={caseData.applicationNumber}
...
export default AdminCreateCaseModal;